...
function deleteSchool (db, schoolID) {
  ...
  p.then(({ matchedCount }) => {
    if (matchedCount === 1) {
      ...
      deleteGPSBySchool(db, schoolID)
      deleteNanniesBySchool(db, schoolID)
      deleteParentRequestsBySchool(db, schoolID)
      deleteRoutesBySchool(db, schoolID)
      deleteSMSBySchool(db, schoolID)
      deleteStudentsBySchool(db, schoolID)
      deleteStudentListsBySchool(db, schoolID)
      deleteStudentTripsBySchool(db, schoolID)
...
const { deleteGPSBySchool } = require('./GPS')
const { deleteNanniesBySchool } = require('./Nanny')
const { deleteParentRequestsBySchool } = require('./ParentRequest')
const { deleteRoutesBySchool } = require('./Route')
const { deleteSMSBySchool } = require('./SMS')
const { deleteStudentsBySchool } = require('./Student')
const { deleteStudentListsBySchool } = require('./StudentList')
const { deleteStudentTripsBySchool } = require('./StudentTrip')
